...
try:
    from vagen.env.hstar import HstarEnvConfig, HstarEnv, HstarService, HstarServiceConfig
    REGISTERED_ENV["hstar"] = {
        "env_cls": HstarEnv,
        "config_cls": HstarEnvConfig,
        "service_cls": HstarService,
        "service_config_cls": HstarServiceConfig
    }
except ImportError as e:
    print(e)
    print("Hstar environment not available. Please check the import path or installation.")
